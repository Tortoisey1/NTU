...
public class MobilePhoneApplication {
	...
	public static void main(String[] args) {
		...
		TwoGPhone phone = new TwoGPhone();
		send("hello John", phone);
		
		FiveGPhone phone2 = new FiveGPhone("green", 7.0, "Tom", 2.0);
		send("hello Tom", phone2);
		
		SixGPhone phone3 = new SixGPhone("white", 5.0, "Jane");
		send("hello Jane", phone3);
	
	}
	
	
	public static void send(String message, MobilePhone phone) {
